			...
			<div class="px-[1.75rem] py-6 flex flex-col">
				<div class="flex justify-between">
                    ...
                    <div class="w-[2rem] h-[2rem]">
                        <button
                            class="bg-gray-100 hover:bg-gray-200 text-gray-800 dark:bg-gray-850 dark:hover:bg-gray-800 dark:text-white font-medium rounded-full transition"
                            on:click={() => show = false}
                            type="button"
                        >
                            X
				...
				<slot>
					<div class=" text-sm text-gray-500 flex-1">
						Apakah anda yakin untuk {title} {entityName}?
					</div>
				</slot>
